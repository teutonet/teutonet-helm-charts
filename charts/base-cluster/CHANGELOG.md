...
## [13.0.0](https://github.com/teutonet/teutonet-helm-charts/compare/base-cluster-v12.4.0...base-cluster-v13.0.0) (2026-09-24)


### ⚠ BREAKING CHANGES

* **base-cluster/ingress:** add envoy as the default ingress provider ([#2272](https://github.com/teutonet/teutonet-helm-charts/issues/2272))

### Features

* **base-cluster/ingress:** add envoy as the default ingress provider ([#2272](https://github.com/teutonet/teutonet-helm-charts/issues/2272)) ([dbc7aab](https://github.com/teutonet/teutonet-helm-charts/commit/dbc7aabf9f012478d63c9a80a0bc81cf9d91af10))
...
* **base-cluster:** generify SLA alert labeling via generic sla label ([#2382](https://github.com/teutonet/teutonet-helm-charts/issues/2382)) ([96daba0](https://github.com/teutonet/teutonet-helm-charts/commit/96daba03558fbbd1c0c61b6cc99fec9c10a55791))
...
* **base-cluster:** trim fullname prefix from kubeconfig account param ([#2396](https://github.com/teutonet/teutonet-helm-charts/issues/2396)) ([830629c](https://github.com/teutonet/teutonet-helm-charts/commit/830629cbc35eb556792aa6cf672a93f30ae9d5f2))


### Bug Fixes

* **base-cluster:** bump tempo memory limit to 2Gi ([#2393](https://github.com/teutonet/teutonet-helm-charts/issues/2393)) ([73b5258](https://github.com/teutonet/teutonet-helm-charts/commit/73b5258c5ca3144782cf87011e57ecb1bb8cd3e5))
* **base-cluster:** deploy envoy Gateway API resources via HelmRelease dependsOn ([#2387](https://github.com/teutonet/teutonet-helm-charts/issues/2387)) ([b4a7217](https://github.com/teutonet/teutonet-helm-charts/commit/b4a721736993b5acb592bca2c701927b17a74d54))
* **base-cluster:** read cluster-cloud annotation from node.cluster.x-k8s.io domain ([#2337](https://github.com/teutonet/teutonet-helm-charts/issues/2337)) ([8dc7ddc](https://github.com/teutonet/teutonet-helm-charts/commit/8dc7ddcb0cab64b381715ba8b8e56e7c9aa8f291))
* **base-cluster:** switch ACME http01 solver to gatewayHTTPRoute for envoy ([#2381](https://github.com/teutonet/teutonet-helm-charts/issues/2381)) ([bbc59b4](https://github.com/teutonet/teutonet-helm-charts/commit/bbc59b4b18db2d976e018a2f892ff471b9e94536))
* **base-cluster:** valid helmRepositories keys and correct patternProperties usage ([#2391](https://github.com/teutonet/teutonet-helm-charts/issues/2391)) ([8db69f4](https://github.com/teutonet/teutonet-helm-charts/commit/8db69f49cefe783bda52fab529a66a4f79b06908))


### Miscellaneous Chores

* **base-cluster/dependencies:** update dependency https://github.com/kubernetes-sigs/gateway-api to v1.6.2 ([#2371](https://github.com/teutonet/teutonet-helm-charts/issues/2371)) ([0b1d1d5](https://github.com/teutonet/teutonet-helm-charts/commit/0b1d1d55884afda6a2a9181febe67207c693b52c))
* **base-cluster/dependencies:** update docker.io/curlimages/curl docker tag to v8.22.0 ([#2370](https://github.com/teutonet/teutonet-helm-charts/issues/2370)) ([b283783](https://github.com/teutonet/teutonet-helm-charts/commit/b28378363461ef4d06daec77fe42aaf08e8595f6))
* **base-cluster/dependencies:** update docker.io/fluxcd/flux-cli docker tag to v2.9.5 ([#2364](https://github.com/teutonet/teutonet-helm-charts/issues/2364)) ([487f6d3](https://github.com/teutonet/teutonet-helm-charts/commit/487f6d377f4a444194dfb2ddf5364c07af721211))
* **base-cluster/dependencies:** update docker.io/grafana/grafana-image-renderer docker tag to v5.12.2 ([#2342](https://github.com/teutonet/teutonet-helm-charts/issues/2342)) ([5d8c06e](https://github.com/teutonet/teutonet-helm-charts/commit/5d8c06eee8934e75787da13e6c65bfadc13cacb6))
* **base-cluster/dependencies:** update docker.io/grafana/grafana-image-renderer docker tag to v5.12.4 ([#2384](https://github.com/teutonet/teutonet-helm-charts/issues/2384)) ([3587896](https://github.com/teutonet/teutonet-helm-charts/commit/3587896a48cf2ff9ae4fda5e7a34f9797df2c1c8))
* **base-cluster/dependencies:** update docker.io/vladgh/gpg docker tag to v1.3.12 ([#2365](https://github.com/teutonet/teutonet-helm-charts/issues/2365)) ([363be7f](https://github.com/teutonet/teutonet-helm-charts/commit/363be7f4076249d3ebd53946de5fcffbdfe12d4f))
* **base-cluster/dependencies:** update helm release alloy to v1.12.0 ([#2345](https://github.com/teutonet/teutonet-helm-charts/issues/2345)) ([12b7282](https://github.com/teutonet/teutonet-helm-charts/commit/12b7282663f744805f6f5a771701493ac03eacad))
* **base-cluster/dependencies:** update helm release alloy to v1.12.1 ([#2354](https://github.com/teutonet/teutonet-helm-charts/issues/2354)) ([52c37e3](https://github.com/teutonet/teutonet-helm-charts/commit/52c37e3d1fc7d62d9816d93183aab48974cb6127))
* **base-cluster/dependencies:** update helm release ingress-nginx to v4.15.1 ([#1565](https://github.com/teutonet/teutonet-helm-charts/issues/1565)) ([075ce0e](https://github.com/teutonet/teutonet-helm-charts/commit/075ce0e3ebe739fdbc96bdc94cb25893e06008f8))
* **base-cluster/dependencies:** update helm release kube-prometheus-stack to v88.5.4 ([#2326](https://github.com/teutonet/teutonet-helm-charts/issues/2326)) ([75a0901](https://github.com/teutonet/teutonet-helm-charts/commit/75a09016d8fedd669467140bfc726398cd9daabd))
* **base-cluster/dependencies:** update helm release kube-prometheus-stack to v88.6.2 ([#2358](https://github.com/teutonet/teutonet-helm-charts/issues/2358)) ([4548208](https://github.com/teutonet/teutonet-helm-charts/commit/45482088e4618d4d1df4a679e1d4c5371ce8012d))
* **base-cluster/dependencies:** update helm release kube-prometheus-stack to v88.6.3 ([#2369](https://github.com/teutonet/teutonet-helm-charts/issues/2369)) ([5292641](https://github.com/teutonet/teutonet-helm-charts/commit/529264135b35e6017c468b80aeab163a1fa53b50))
* **base-cluster/dependencies:** update helm release kube-prometheus-stack to v89 ([#2373](https://github.com/teutonet/teutonet-helm-charts/issues/2373)) ([53877af](https://github.com/teutonet/teutonet-helm-charts/commit/53877af4578f55346be632ad402b89eeb3791625))
* **base-cluster/dependencies:** update helm release kyverno to v3.9.0 ([#2346](https://github.com/teutonet/teutonet-helm-charts/issues/2346)) ([e89ab86](https://github.com/teutonet/teutonet-helm-charts/commit/e89ab864c13a414059fce1d2c2ac9cd40b39e204))
* **base-cluster/dependencies:** update helm release kyverno to v3.9.1 ([#2385](https://github.com/teutonet/teutonet-helm-charts/issues/2385)) ([c385a12](https://github.com/teutonet/teutonet-helm-charts/commit/c385a12ade96020d767042c2e50310472f653c24))
* **base-cluster/dependencies:** update helm release kyverno-policies to v3.9.0 ([#2347](https://github.com/teutonet/teutonet-helm-charts/issues/2347)) ([b8bf8d7](https://github.com/teutonet/teutonet-helm-charts/commit/b8bf8d717100f8317d96831d25149faea5b231d8))
* **base-cluster/dependencies:** update helm release kyverno-policies to v3.9.1 ([#2386](https://github.com/teutonet/teutonet-helm-charts/issues/2386)) ([e882f8b](https://github.com/teutonet/teutonet-helm-charts/commit/e882f8ba3798b4dfefb7fc7d5e707fd419c7a8bd))
* **base-cluster/dependencies:** update helm release loki to v18.11.3 ([#2348](https://github.com/teutonet/teutonet-helm-charts/issues/2348)) ([3cb82cb](https://github.com/teutonet/teutonet-helm-charts/commit/3cb82cb2df4a704209f63d98f27e8b1736d42101))
* **base-cluster/dependencies:** update helm release loki to v18.11.4 ([#2357](https://github.com/teutonet/teutonet-helm-charts/issues/2357)) ([4f90d15](https://github.com/teutonet/teutonet-helm-charts/commit/4f90d155c56d9deec85332199adfd4b01d49e307))
* **base-cluster/dependencies:** update helm release loki to v18.11.7 ([#2359](https://github.com/teutonet/teutonet-helm-charts/issues/2359)) ([3e8abe0](https://github.com/teutonet/teutonet-helm-charts/commit/3e8abe0e4c8a94a118e0f64cfd325344c23308c1))
* **base-cluster/dependencies:** update helm release loki to v18.12.0 ([#2374](https://github.com/teutonet/teutonet-helm-charts/issues/2374)) ([33a58b4](https://github.com/teutonet/teutonet-helm-charts/commit/33a58b4ad6fbaa3e574216be34c367fdecc6dc91))
* **base-cluster/dependencies:** update helm release loki to v18.12.2 ([#2376](https://github.com/teutonet/teutonet-helm-charts/issues/2376)) ([073983b](https://github.com/teutonet/teutonet-helm-charts/commit/073983b83f9131ae1d30f496b080afb8275e8936))
...
* **base-cluster/dependencies:** update helm release loki to v18.9.1 ([#2329](https://github.com/teutonet/teutonet-helm-charts/issues/2329)) ([b0f4f25](https://github.com/teutonet/teutonet-helm-charts/commit/b0f4f25b45125de67b553b52576cbfbb64d3179f))
* **base-cluster/dependencies:** update helm release metrics-server to v3.14.0 ([#2328](https://github.com/teutonet/teutonet-helm-charts/issues/2328)) ([1efef87](https://github.com/teutonet/teutonet-helm-charts/commit/1efef87d97501bbb5946e14c39cb758963b799ca))
* **base-cluster/dependencies:** update helm release prometheus-blackbox-exporter to v11.18.0 ([#2363](https://github.com/teutonet/teutonet-helm-charts/issues/2363)) ([3b80697](https://github.com/teutonet/teutonet-helm-charts/commit/3b8069775acd53531f044ca2d1eb61cb734c6ecf))
...
* **base-cluster/dependencies:** update helm release tempo to v2.3.0 ([#2349](https://github.com/teutonet/teutonet-helm-charts/issues/2349)) ([862a761](https://github.com/teutonet/teutonet-helm-charts/commit/862a76118fa4a09f290c605ef701ed4a6ce5c7d9))
* **base-cluster/dependencies:** update helm release tetragon to v1.7.1 ([#2343](https://github.com/teutonet/teutonet-helm-charts/issues/2343)) ([f18d333](https://github.com/teutonet/teutonet-helm-charts/commit/f18d333f6c8b5c1cbfaeb9e4c696291480bd01d3))
* **base-cluster/dependencies:** update helm release traefik to v41.3.0 ([#2350](https://github.com/teutonet/teutonet-helm-charts/issues/2350)) ([c6b7d1c](https://github.com/teutonet/teutonet-helm-charts/commit/c6b7d1cbf0be99c4049fdbac9137b946b9293637))
* **base-cluster/dependencies:** update helm release traefik to v41.4.0 ([#2356](https://github.com/teutonet/teutonet-helm-charts/issues/2356)) ([008e034](https://github.com/teutonet/teutonet-helm-charts/commit/008e0343b9fe4415a052862f4a896b3381514528))
* **base-cluster/dependencies:** update helm release traefik to v41.6.0 ([#2380](https://github.com/teutonet/teutonet-helm-charts/issues/2380)) ([40a59a5](https://github.com/teutonet/teutonet-helm-charts/commit/40a59a5d5df0c4dad0c2290cc04adedb3a96648e))
* **base-cluster/dependencies:** update helm release trivy-operator to v0.36.0 ([#2351](https://github.com/teutonet/teutonet-helm-charts/issues/2351)) ([117798d](https://github.com/teutonet/teutonet-helm-charts/commit/117798db8c4b34c5bab7462a287e0871ce6cda14))
* **base-cluster/dependencies:** update helm release velero to v12 ([#2073](https://github.com/teutonet/teutonet-helm-charts/issues/2073)) ([c10b912](https://github.com/teutonet/teutonet-helm-charts/commit/c10b912b71ea38c0e11a4a38988611354fb2843a))
* **base-cluster:** HR reconciliation cannot be relied upon ([#2339](https://github.com/teutonet/teutonet-helm-charts/issues/2339)) ([b9de0ef](https://github.com/teutonet/teutonet-helm-charts/commit/b9de0ef67111fd8da723620f930bde27e58ddbcd))
...
* **base-cluster/ingress:** keep traefik Service on provider switch ([#2271](https://github.com/teutonet/teutonet-helm-charts/issues/2271)) ([e11463f](https://github.com/teutonet/teutonet-helm-charts/commit/e11463f867885c4c5c1d15786de913f153c13e68))
* **base-cluster:** add condition to flux.gitRepositories ([#2250](https://github.com/teutonet/teutonet-helm-charts/issues/2250)) ([9665f87](https://github.com/teutonet/teutonet-helm-charts/commit/9665f87cda8e9830193ab5ff3152e208dfcb8769))
* **base-cluster:** migrate ci-values scenarios to helm-unittest coverage ([#2253](https://github.com/teutonet/teutonet-helm-charts/issues/2253)) ([3391562](https://github.com/teutonet/teutonet-helm-charts/commit/33915627453281776bc0018a72fc0f6a5a1b58e9))


### Miscellaneous Chores

* **base-cluster/dependencies:** update common docker tag to v2.2.0 ([#2279](https://github.com/teutonet/teutonet-helm-charts/issues/2279)) ([a87189f](https://github.com/teutonet/teutonet-helm-charts/commit/a87189faae29329e1e0b408b325af0f100409b0b))
* **base-cluster/dependencies:** update docker.io/fluxcd/flux-cli docker tag to v2.9.3 ([#2262](https://github.com/teutonet/teutonet-helm-charts/issues/2262)) ([d4ac54e](https://github.com/teutonet/teutonet-helm-charts/commit/d4ac54e3a5d36e644763b16fcc4033f5b6687151))
* **base-cluster/dependencies:** update docker.io/fluxcd/flux-cli docker tag to v2.9.4 ([#2302](https://github.com/teutonet/teutonet-helm-charts/issues/2302)) ([ecbbbed](https://github.com/teutonet/teutonet-helm-charts/commit/ecbbbedbd4d65c4b851932df26001947d5b4f6db))
* **base-cluster/dependencies:** update docker.io/grafana/grafana-image-renderer docker tag to v5.10.3 ([#2242](https://github.com/teutonet/teutonet-helm-charts/issues/2242)) ([0f672e1](https://github.com/teutonet/teutonet-helm-charts/commit/0f672e147b97cc7b936fd7265dd826f335d6eeaf))
* **base-cluster/dependencies:** update docker.io/grafana/grafana-image-renderer docker tag to v5.12.0 ([#2280](https://github.com/teutonet/teutonet-helm-charts/issues/2280)) ([78cd5fe](https://github.com/teutonet/teutonet-helm-charts/commit/78cd5fed9d2cb07b29f0f965117052b9babda4d0))
* **base-cluster/dependencies:** update docker.io/grafana/grafana-image-renderer docker tag to v5.12.1 ([#2309](https://github.com/teutonet/teutonet-helm-charts/issues/2309)) ([345d3fb](https://github.com/teutonet/teutonet-helm-charts/commit/345d3fbaa76f3db2466babdb2f93710d0836c52f))
* **base-cluster/dependencies:** update docker.io/vladgh/gpg docker tag to v1.3.11 ([#2278](https://github.com/teutonet/teutonet-helm-charts/issues/2278)) ([0a587c0](https://github.com/teutonet/teutonet-helm-charts/commit/0a587c084b5a041278b0b18991a6a5e4f65beb9f))
* **base-cluster/dependencies:** update helm release alloy to v1.10.1 ([#2235](https://github.com/teutonet/teutonet-helm-charts/issues/2235)) ([ee11193](https://github.com/teutonet/teutonet-helm-charts/commit/ee11193d44943c73ed9c2e6b26f578422efcf13f))
* **base-cluster/dependencies:** update helm release alloy to v1.11.1 ([#2268](https://github.com/teutonet/teutonet-helm-charts/issues/2268)) ([e770a87](https://github.com/teutonet/teutonet-helm-charts/commit/e770a873e48d7bbb4d49f76b9485e0e72baef4c4))
* **base-cluster/dependencies:** update helm release k8up to v4.10.0 ([#2281](https://github.com/teutonet/teutonet-helm-charts/issues/2281)) ([c6653d8](https://github.com/teutonet/teutonet-helm-charts/commit/c6653d89fdae648474bdc13a6aa2df15c0477a2d))
* **base-cluster/dependencies:** update helm release kube-prometheus-stack to v88 ([#2292](https://github.com/teutonet/teutonet-helm-charts/issues/2292)) ([54a2ce3](https://github.com/teutonet/teutonet-helm-charts/commit/54a2ce375ecd2ecf95058a1cc34855f89aa7f28a))
* **base-cluster/dependencies:** update helm release kube-prometheus-stack to v88.3.0 ([#2305](https://github.com/teutonet/teutonet-helm-charts/issues/2305)) ([60466c2](https://github.com/teutonet/teutonet-helm-charts/commit/60466c2bc221d2262ffc5188ebf7d6eac4c6aeb5))
* **base-cluster/dependencies:** update helm release kyverno to v3.8.2 ([#2237](https://github.com/teutonet/teutonet-helm-charts/issues/2237)) ([b4a6967](https://github.com/teutonet/teutonet-helm-charts/commit/b4a696782df0208db79b9e2c3ecc045189a18cf3))
* **base-cluster/dependencies:** update helm release loki to v18 ([#2293](https://github.com/teutonet/teutonet-helm-charts/issues/2293)) ([3d0c91e](https://github.com/teutonet/teutonet-helm-charts/commit/3d0c91e59d40311462bbcce8f94ed860147b10ee))
* **base-cluster/dependencies:** update helm release loki to v18.8.0 ([#2310](https://github.com/teutonet/teutonet-helm-charts/issues/2310)) ([42d8cf4](https://github.com/teutonet/teutonet-helm-charts/commit/42d8cf41b9a75c25822985fae2be4b13d1be08ee))
* **base-cluster/dependencies:** update helm release prometheus-blackbox-exporter to v11.16.0 ([#2282](https://github.com/teutonet/teutonet-helm-charts/issues/2282)) ([b1e913e](https://github.com/teutonet/teutonet-helm-charts/commit/b1e913ede1bb201b62058aa14be9dbbfcbddc88c))
* **base-cluster/dependencies:** update helm release prometheus-blackbox-exporter to v11.17.2 ([#2306](https://github.com/teutonet/teutonet-helm-charts/issues/2306)) ([15b669d](https://github.com/teutonet/teutonet-helm-charts/commit/15b669dbb1b07764c54eeee7d160b08c34be0290))
* **base-cluster/dependencies:** update helm release reflector to v10.0.63 ([#2267](https://github.com/teutonet/teutonet-helm-charts/issues/2267)) ([9b6afa8](https://github.com/teutonet/teutonet-helm-charts/commit/9b6afa8b529f912f723647cb3323591423d573a8))
* **base-cluster/dependencies:** update helm release reflector to v10.0.64 ([#2304](https://github.com/teutonet/teutonet-helm-charts/issues/2304)) ([954825f](https://github.com/teutonet/teutonet-helm-charts/commit/954825ff7aff38a253accb2720cfd6666a99fb25))
* **base-cluster/dependencies:** update helm release traefik to v41 ([#2294](https://github.com/teutonet/teutonet-helm-charts/issues/2294)) ([62363be](https://github.com/teutonet/teutonet-helm-charts/commit/62363be459663da8db62d4510f8c63d121db0756))
* **base-cluster/dependencies:** update helm release trivy-operator to v0.35.0 ([#2283](https://github.com/teutonet/teutonet-helm-charts/issues/2283)) ([2becb7c](https://github.com/teutonet/teutonet-helm-charts/commit/2becb7cd55e02173b74dc98cf95adc1adbe711a8))
...
* **base-cluster/ingress:** add nginx compatibility option for traefik ([#2190](https://github.com/teutonet/teutonet-helm-charts/issues/2190)) ([2d12d34](https://github.com/teutonet/teutonet-helm-charts/commit/2d12d343e2f612081f2734b27adb615c99508b59))
* **base-cluster/ingress:** don't throw errors when both conrollers are (manually) deployed ([#2225](https://github.com/teutonet/teutonet-helm-charts/issues/2225)) ([e3cb179](https://github.com/teutonet/teutonet-helm-charts/commit/e3cb179392126d7e7bad35c50b968a86109686b1))


### Bug Fixes

* **base-cluster/monitoring:** disable monitoring of hosted/disabled components ([#2208](https://github.com/teutonet/teutonet-helm-charts/issues/2208)) ([ed7228b](https://github.com/teutonet/teutonet-helm-charts/commit/ed7228b386c7e17c8062d891fef1bb6006cc4f77))
* **base-cluster/monitoring:** disallow unsupported receivers ([#2223](https://github.com/teutonet/teutonet-helm-charts/issues/2223)) ([a3e6270](https://github.com/teutonet/teutonet-helm-charts/commit/a3e62708f84e4b6196ee0e677da01dfe3ecd8d43))
* **base-cluster:** various wrong invocations of common.resources ([#2224](https://github.com/teutonet/teutonet-helm-charts/issues/2224)) ([18f5e8d](https://github.com/teutonet/teutonet-helm-charts/commit/18f5e8d2b0e83d7af7233f8e04254db24657fafd))


### Miscellaneous Chores

* **base-cluster/cert-manager:** add tests for certificates condition ([#2209](https://github.com/teutonet/teutonet-helm-charts/issues/2209)) ([6e00831](https://github.com/teutonet/teutonet-helm-charts/commit/6e0083198e14bff6368fd38153e454a17a88cb7c))
* **base-cluster/dependencies:** update docker.io/curlimages/curl docker tag to v8.21.0 ([#2200](https://github.com/teutonet/teutonet-helm-charts/issues/2200)) ([45e4538](https://github.com/teutonet/teutonet-helm-charts/commit/45e45388f88dcd1a37a758e23a45c5252685b657))
* **base-cluster/dependencies:** update docker.io/grafana/grafana-image-renderer docker tag to v5.8.11 ([#2181](https://github.com/teutonet/teutonet-helm-charts/issues/2181)) ([5b00500](https://github.com/teutonet/teutonet-helm-charts/commit/5b00500b045f6c829366d92e000be8b42b23f3db))
* **base-cluster/dependencies:** update docker.io/grafana/grafana-image-renderer docker tag to v5.9.1 ([#2207](https://github.com/teutonet/teutonet-helm-charts/issues/2207)) ([0fd50f4](https://github.com/teutonet/teutonet-helm-charts/commit/0fd50f46e415599e4a6cb9bc0b5a1b953037ab33))
* **base-cluster/dependencies:** update helm release alloy to v1.10.0 ([#2201](https://github.com/teutonet/teutonet-helm-charts/issues/2201)) ([452bb5b](https://github.com/teutonet/teutonet-helm-charts/commit/452bb5b7edf6a7a7fc7a8ed8459145bbe548695a))
* **base-cluster/dependencies:** update helm release descheduler to v0.36.0 ([#2188](https://github.com/teutonet/teutonet-helm-charts/issues/2188)) ([40f5331](https://github.com/teutonet/teutonet-helm-charts/commit/40f5331df5828e19791d6c9cc892f7a53dd7f393))
* **base-cluster/dependencies:** update helm release kyverno to v3.8.1 ([#2182](https://github.com/teutonet/teutonet-helm-charts/issues/2182)) ([5eb55d6](https://github.com/teutonet/teutonet-helm-charts/commit/5eb55d673a43998ec9e35f3b0f14501879887482))
* **base-cluster/dependencies:** update helm release kyverno-policies to v3.8.1 ([#2143](https://github.com/teutonet/teutonet-helm-charts/issues/2143)) ([e150938](https://github.com/teutonet/teutonet-helm-charts/commit/e1509381bbccf3da0f1cb0b21a2275cb158ebb1a))
* **base-cluster/dependencies:** update helm release metrics-server to v3.13.1 ([#2198](https://github.com/teutonet/teutonet-helm-charts/issues/2198)) ([90852de](https://github.com/teutonet/teutonet-helm-charts/commit/90852defe21b9dd03b5555f8cf9ab8646a4daf2b))
* **base-cluster/dependencies:** update helm release oauth2-proxy to v10.7.0 ([#2203](https://github.com/teutonet/teutonet-helm-charts/issues/2203)) ([9d3585d](https://github.com/teutonet/teutonet-helm-charts/commit/9d3585d1cab4d5d1cbf2c74518637bf412d167fe))
* **base-cluster/dependencies:** update helm release reflector to v10.0.52 ([#2184](https://github.com/teutonet/teutonet-helm-charts/issues/2184)) ([497b17b](https://github.com/teutonet/teutonet-helm-charts/commit/497b17ba90837fc8d47c0b395c12cb26179cf5b4))
* **base-cluster/dependencies:** update helm release tempo to v2.1.2 ([#2185](https://github.com/teutonet/teutonet-helm-charts/issues/2185)) ([d003102](https://github.com/teutonet/teutonet-helm-charts/commit/d00310219ee46c0ee0588ffafa9b6b7a15f6517b))
* **base-cluster/dependencies:** update helm release tempo to v2.2.3 ([#2205](https://github.com/teutonet/teutonet-helm-charts/issues/2205)) ([afafd15](https://github.com/teutonet/teutonet-helm-charts/commit/afafd15de52910d14bd9fc7ba39d0cd6c87a1faa))
* **base-cluster/dependencies:** update helm release tetragon to v1.7.0 ([#2149](https://github.com/teutonet/teutonet-helm-charts/issues/2149)) ([1798063](https://github.com/teutonet/teutonet-helm-charts/commit/1798063f64e68e00367ca8603ec1befb3170b475))

## [12.0.0](https://github.com/teutonet/teutonet-helm-charts/compare/base-cluster-v11.2.0...base-cluster-v12.0.0) (2026-06-15)
...
* **base-cluster:** add extra ports for traefik and gatewayapi ([#2191](https://github.com/teutonet/teutonet-helm-charts/issues/2191)) ([f774fbd](https://github.com/teutonet/teutonet-helm-charts/commit/f774fbd6d1ecedb3316679f78262d3c6d4e4d33c))
* **base-cluster:** add unit tests ([#2161](https://github.com/teutonet/teutonet-helm-charts/issues/2161)) ([bfa7197](https://github.com/teutonet/teutonet-helm-charts/commit/bfa7197f569e056fbf2147ae3e97ab46837b8e82))
* **base-cluster:** migrate loki to grafana-community helm chart ([#2118](https://github.com/teutonet/teutonet-helm-charts/issues/2118)) ([f2ab0f1](https://github.com/teutonet/teutonet-helm-charts/commit/f2ab0f106afc1e9c3407824618234019e79d3256))
...
* **base-cluster/dependencies:** update common docker tag to v2.1.1 ([#2148](https://github.com/teutonet/teutonet-helm-charts/issues/2148)) ([a10a10d](https://github.com/teutonet/teutonet-helm-charts/commit/a10a10d5d7b914757f9df84f1b5b3f4137d147e9))
...
* **base-cluster/dependencies:** update docker.io/fluxcd/flux-cli docker tag to v2.8.8 ([#2169](https://github.com/teutonet/teutonet-helm-charts/issues/2169)) ([25ac5b7](https://github.com/teutonet/teutonet-helm-charts/commit/25ac5b74396863ccbd4fbcc377ede16b7d6be5e1))
...
* **base-cluster/dependencies:** update docker.io/vladgh/gpg docker tag to v1.3.10 ([#2173](https://github.com/teutonet/teutonet-helm-charts/issues/2173)) ([44e3611](https://github.com/teutonet/teutonet-helm-charts/commit/44e36117e4813249f18fc4abc453fd8ea0b08d02))
...
* **base-cluster/dependencies:** update helm release alloy to v1.8.2 ([#2155](https://github.com/teutonet/teutonet-helm-charts/issues/2155)) ([d79a915](https://github.com/teutonet/teutonet-helm-charts/commit/d79a915b7ba6f87c5c5d73cba31adca249739afa))
...
* **base-cluster/dependencies:** update helm release traefik to v40 ([#2158](https://github.com/teutonet/teutonet-helm-charts/issues/2158)) ([95e8566](https://github.com/teutonet/teutonet-helm-charts/commit/95e85661f1ac692b0949c580ea318e1b470967a0))
...
* **base-cluster:** update gateway-api ([#2171](https://github.com/teutonet/teutonet-helm-charts/issues/2171)) ([5d44ccb](https://github.com/teutonet/teutonet-helm-charts/commit/5d44ccb57c72f0838b073c2fcc3e74f21402ab61))
...
* **base-cluster:** add support for podSecurityStandards ([#2079](https://github.com/teutonet/teutonet-helm-charts/issues/2079)) ([d71f387](https://github.com/teutonet/teutonet-helm-charts/commit/d71f3876c84d2d8dcf6ece93c9a3154519debf0b))


### Bug Fixes

* **base-cluster/monitoring:** disable scrapeConfigSelector ([#2076](https://github.com/teutonet/teutonet-helm-charts/issues/2076)) ([e0cd387](https://github.com/teutonet/teutonet-helm-charts/commit/e0cd38786358b61bb597818d24171027a7206e3b))


### Miscellaneous Chores

* **base-cluster/dependencies:** update common docker tag to v2 ([#2070](https://github.com/teutonet/teutonet-helm-charts/issues/2070)) ([bfdc4f7](https://github.com/teutonet/teutonet-helm-charts/commit/bfdc4f7e00b570299dd4710be315948f11df702b))
* **base-cluster/dependencies:** update docker.io/curlimages/curl docker tag to v8.19.0 ([#2054](https://github.com/teutonet/teutonet-helm-charts/issues/2054)) ([e44044f](https://github.com/teutonet/teutonet-helm-charts/commit/e44044fbeae4cdc321f339c02b86f57c52b060d9))
* **base-cluster/dependencies:** update docker.io/fluxcd/flux-cli docker tag to v2.8.5 ([#2050](https://github.com/teutonet/teutonet-helm-charts/issues/2050)) ([1e47fbe](https://github.com/teutonet/teutonet-helm-charts/commit/1e47fbe6476c8868bbd696763a82a87bbc42ea3b))
* **base-cluster/dependencies:** update docker.io/grafana/grafana-image-renderer docker tag to v5.8.1 ([#2055](https://github.com/teutonet/teutonet-helm-charts/issues/2055)) ([ca5e543](https://github.com/teutonet/teutonet-helm-charts/commit/ca5e543b7323e7ee0ae3f8afe40361511e24219c))
* **base-cluster/dependencies:** update docker.io/grafana/grafana-image-renderer docker tag to v5.8.2 ([#2088](https://github.com/teutonet/teutonet-helm-charts/issues/2088)) ([3b4e947](https://github.com/teutonet/teutonet-helm-charts/commit/3b4e947dc24784972311785b343370f824834fa5))
* **base-cluster/dependencies:** update helm release alloy to v1.7.0 ([#2056](https://github.com/teutonet/teutonet-helm-charts/issues/2056)) ([8b346ef](https://github.com/teutonet/teutonet-helm-charts/commit/8b346ef0f0eaa78fe185bded6ebe4164e1c0985e))
* **base-cluster/dependencies:** update helm release descheduler to v0.35.1 ([#2057](https://github.com/teutonet/teutonet-helm-charts/issues/2057)) ([bf57119](https://github.com/teutonet/teutonet-helm-charts/commit/bf57119fc4cf60bbf94ba2f61782c40b0c3cece6))
* **base-cluster/dependencies:** update helm release k8up to v4.8.7 ([#2032](https://github.com/teutonet/teutonet-helm-charts/issues/2032)) ([4c19b2b](https://github.com/teutonet/teutonet-helm-charts/commit/4c19b2bbddc8257e34ab585d76f68ee4b8095969))
* **base-cluster/dependencies:** update helm release k8up to v4.9.0 ([#2058](https://github.com/teutonet/teutonet-helm-charts/issues/2058)) ([32139f5](https://github.com/teutonet/teutonet-helm-charts/commit/32139f57b824dd74fe54ce2f36588701244f98fb))
* **base-cluster/dependencies:** update helm release kube-prometheus-stack to v83 ([#2066](https://github.com/teutonet/teutonet-helm-charts/issues/2066)) ([0a4f32c](https://github.com/teutonet/teutonet-helm-charts/commit/0a4f32c6877321957298ac74504c2b36d5d159e8))
* **base-cluster/dependencies:** update helm release kube-prometheus-stack to v83.6.0 ([#2087](https://github.com/teutonet/teutonet-helm-charts/issues/2087)) ([275bd3c](https://github.com/teutonet/teutonet-helm-charts/commit/275bd3c83ca8c7bc266e185d668bf4a363a07e3a))
* **base-cluster/dependencies:** update helm release kyverno to v3.7.1 ([#1852](https://github.com/teutonet/teutonet-helm-charts/issues/1852)) ([9cdba87](https://github.com/teutonet/teutonet-helm-charts/commit/9cdba87d96e0d3e7b225ea9b7caa37346df45d5c))
* **base-cluster/dependencies:** update helm release kyverno-policies to v3.7.1 ([#1907](https://github.com/teutonet/teutonet-helm-charts/issues/1907)) ([409dc17](https://github.com/teutonet/teutonet-helm-charts/commit/409dc17c69385050ce80efc931fbffa32aed6e8b))
* **base-cluster/dependencies:** update helm release loki to v6.55.0 ([#2060](https://github.com/teutonet/teutonet-helm-charts/issues/2060)) ([5b23edc](https://github.com/teutonet/teutonet-helm-charts/commit/5b23edc5ee3800cd90620d2c6a5ef7d1464d440a))
* **base-cluster/dependencies:** update helm release oauth2-proxy to v10.1.5 ([#2033](https://github.com/teutonet/teutonet-helm-charts/issues/2033)) ([b84304a](https://github.com/teutonet/teutonet-helm-charts/commit/b84304aaa13fbb73f1328dfc9c6717c6bcbf162e))
* **base-cluster/dependencies:** update helm release oauth2-proxy to v10.4.3 ([#2061](https://github.com/teutonet/teutonet-helm-charts/issues/2061)) ([f4ee377](https://github.com/teutonet/teutonet-helm-charts/commit/f4ee377e1c4a3ce8f8e3814aba83bedba2d8111f))
* **base-cluster/dependencies:** update helm release reflector to v10.0.32 ([#2035](https://github.com/teutonet/teutonet-helm-charts/issues/2035)) ([9f6b9f6](https://github.com/teutonet/teutonet-helm-charts/commit/9f6b9f6ddc54c1372a8f5a00182a06f883390cab))
* **base-cluster/dependencies:** update helm release reflector to v10.0.34 ([#2067](https://github.com/teutonet/teutonet-helm-charts/issues/2067)) ([9cd840c](https://github.com/teutonet/teutonet-helm-charts/commit/9cd840c3ac61e1624d0c0d1a1bb6d1f75528800d))
* **base-cluster/dependencies:** update helm release reflector to v10.0.35 ([#2085](https://github.com/teutonet/teutonet-helm-charts/issues/2085)) ([c42bfaf](https://github.com/teutonet/teutonet-helm-charts/commit/c42bfaf5a3c0108a587296aa492f0457a143896d))
* **base-cluster/dependencies:** update helm release tempo to v2 ([#2072](https://github.com/teutonet/teutonet-helm-charts/issues/2072)) ([27ff691](https://github.com/teutonet/teutonet-helm-charts/commit/27ff69147d4f6a50d7ccb3c06b3fe74299b17ee6))
* **base-cluster/dependencies:** update helm release tetragon to v1.6.1 ([#2052](https://github.com/teutonet/teutonet-helm-charts/issues/2052)) ([8015fc1](https://github.com/teutonet/teutonet-helm-charts/commit/8015fc105cc698bd3c0583436d8ec1a1278e09d8))
* **base-cluster/dependencies:** update helm release traefik to v39.0.8 ([#2086](https://github.com/teutonet/teutonet-helm-charts/issues/2086)) ([fa42cee](https://github.com/teutonet/teutonet-helm-charts/commit/fa42cee8e3bb215d04ca3906de6648539a69429f))
...
* **base-cluster/monitoring:** match by instance as well ([#2024](https://github.com/teutonet/teutonet-helm-charts/issues/2024)) ([7d2b6b3](https://github.com/teutonet/teutonet-helm-charts/commit/7d2b6b3c8c28e5c2c7fa7b0289ef688133eac00b))

## [11.1.0](https://github.com/teutonet/teutonet-helm-charts/compare/base-cluster-v11.0.1...base-cluster-v11.1.0) (2026-03-16)
...
* **base-cluster/kyverno:** allow setting kyverno resources ([#1986](https://github.com/teutonet/teutonet-helm-charts/issues/1986)) ([71b9db4](https://github.com/teutonet/teutonet-helm-charts/commit/71b9db47714485beb9abe1f52d1e95e9eb70e289))
* **base-cluster/monitoring:** add alert about base-cluster updates ([#1937](https://github.com/teutonet/teutonet-helm-charts/issues/1937)) ([a3c63a7](https://github.com/teutonet/teutonet-helm-charts/commit/a3c63a7d7e4dbf3ab000632a724db96229918b95))
* **base-cluster/monitoring:** add alert about deprecated APIs ([#2021](https://github.com/teutonet/teutonet-helm-charts/issues/2021)) ([cb334dd](https://github.com/teutonet/teutonet-helm-charts/commit/cb334ddc3c113c1d27b2fe06ec2fe05d2e3616f7))


### Bug Fixes

* **base-cluster/deadMansSwitch:** fix alertmanager healthchecks URL ([#2019](https://github.com/teutonet/teutonet-helm-charts/issues/2019)) ([d874a56](https://github.com/teutonet/teutonet-helm-charts/commit/d874a5650c16e5c83d36ea6553d5a0afc3e7d68f))
...
* **base-cluster/monitoring:** only roll out alloy tracing ports if enabled ([#2005](https://github.com/teutonet/teutonet-helm-charts/issues/2005)) ([ea44c4d](https://github.com/teutonet/teutonet-helm-charts/commit/ea44c4d8ac1e31d2823fd277a2898e3a47bfc973))
...
* **base-cluster/dependencies:** update helm release kube-prometheus-stack to v82 ([#1995](https://github.com/teutonet/teutonet-helm-charts/issues/1995)) ([45ef213](https://github.com/teutonet/teutonet-helm-charts/commit/45ef213e9f9a499b579a121a8cd0c4e392016ed5))
...
* **base-cluster/dependencies:** update helm release oauth2-proxy to v10.1.4 ([#2001](https://github.com/teutonet/teutonet-helm-charts/issues/2001)) ([8ffa211](https://github.com/teutonet/teutonet-helm-charts/commit/8ffa211da3f352553b689e75e7e608c19afba0d0))
...
* **base-cluster/dependencies:** update helm release reflector to v10.0.19 ([#1999](https://github.com/teutonet/teutonet-helm-charts/issues/1999)) ([a2b5189](https://github.com/teutonet/teutonet-helm-charts/commit/a2b5189ff6da9659446384f07851cf221a823ca2))
...
* **base-cluster/dependencies:** update helm release tempo to v1.26.7 ([#2000](https://github.com/teutonet/teutonet-helm-charts/issues/2000)) ([6cabd54](https://github.com/teutonet/teutonet-helm-charts/commit/6cabd54bbc92ebc2011c0186748c401dd7bacf12))
...
* **base-cluster:** update kyverno ([#1918](https://github.com/teutonet/teutonet-helm-charts/issues/1918)) ([a503ef6](https://github.com/teutonet/teutonet-helm-charts/commit/a503ef6b59d7bd3c43ac506cea1ae67c682e5ef3))
* migrate kyverno config ([71b9db4](https://github.com/teutonet/teutonet-helm-charts/commit/71b9db47714485beb9abe1f52d1e95e9eb70e289))
